...
Future getData() async {
  ...
  if (response.statusCode == 200) {
    ...
    return CovReport.fromJson(jsonDecode(response.body));
    // return (responseJson as List).map((p) => Welcome.fromJson(p)).toList();
  } else {
...
CovReport welcomeFromJson(String str) => CovReport.fromJson(json.decode(str));

String welcomeToJson(CovReport data) => json.encode(data.toJson());
